...
if device_type == "mps":
    ...
    input_data_dir_path = "/tmp/nrt204/FragmentPredictor/data/processed_data/model_data/shared_crf/model_without_errors" #TEST ON SCARB CLUSTER
    num_workers_cpu = 4
    pin_memory = True
...
wandb_project_name = "tune_shared_esm2_no_errors" #MODIFY
