...
wandb_project_name = "train_esm2"
no_genomes = "100_genomes" #CORRECT BASED. ON TRAINING SAMPLES!!
...
class LinearChainCRF(nn.Module):
    ...
    def __init__(self, 
        ...
        with torch.no_grad():
            self.crf.transitions[~self.constraint_mask] = -10  # forbidden → -2
            self.crf.transitions[self.constraint_mask] = 10    # allowed → 1
...
def training_iteration(i, batch, scaler, model, optimizer, device, epoch_losses):
    ...
    if i % 20 == 0:
        ...
        del outputs, loss
        del inputs_aa_rf0, attention_mask_aa_rf0, inputs_aa_rf1, attention_mask_aa_rf1, inputs_aa_rf2, attention_mask_aa_rf2, encoded_labels
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                counter_patience = 0
                torch.save(model.state_dict(), f"../../../data/processed_data/model_data/shared_crf/model_with_errors/models/esm2_trained_{no_genomes}.pth")
            else:
                counter_patience += 1
