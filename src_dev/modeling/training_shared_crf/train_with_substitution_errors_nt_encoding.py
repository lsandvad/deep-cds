...
wandb_project_name = "train_codon_encoding_substitution_errors" 
...
def encode_data(processed_samples_df, max_len):
    ...
    Args:
        ...
        max_len (int): Max codon length for model input
...
class CDSPredictor(nn.Module):
    ...
    def __init__(self,
        ...
        self.output_proj = nn.Linear(3*4, num_encoded_labels)
...
depth_transformer_encoder_blocks = 10
n_attention_heads = 8
d_model = 128
dropout_rate_1 = 0.3
dropout_rate_2 = 0.2
lr_scratch = 0.00011973124159350484
act_function = "gelu"
transition_weight = -2.6854514604650883
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), f"{models_output_dir_path}/codon_encoding_model_{dataset_size}_trained.pth")
                counter_patience = 0
            else:
                counter_patience += 1
