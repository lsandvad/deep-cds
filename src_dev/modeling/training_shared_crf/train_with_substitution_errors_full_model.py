...
# Access them
act_function = cfg.hyperparameters.act_function  # 'gelu'
depth_transformer_encoder_blocks = cfg.hyperparameters.depth_transformer_encoder_blocks  # 6
dropout_rate_1 = cfg.hyperparameters.dropout_rate_1  # 0.3
dropout_rate_2 = cfg.hyperparameters.dropout_rate_2  # 0.3
lr_esm2 = cfg.hyperparameters.lr_esm2  # 1.617e-7
lr_scratch = cfg.hyperparameters.lr_scratch  # 0.00001516
n_attention_heads = cfg.hyperparameters.n_attention_heads  # 4
transition_weight = cfg.hyperparameters.transition_weight  # -3.131
...
wandb.init(
    ...
    name=f"train_{dataset_size}_seed_{args.seed}")  # ADD THIS


# Create generator for DataLoader
generator = torch.Generator()  # ADD THIS
...
train_loader = DataLoader(
    ...
    drop_last=True,
    persistent_workers=True if num_workers_cpu > 0 else False,
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), f"{models_output_dir_path}/full_model_{dataset_size}_seed_{args.seed}_trained.pth") #modify
                counter_patience = 0
            else:
                counter_patience += 1
