...
wandb_project_name = "train_full_model_no_errors"
...
depth_transformer_encoder_blocks = 4
n_attention_heads = 4
dropout_rate_1 = 0.3
dropout_rate_2 = 0.3
lr_scratch = 0.00005460441323176815
lr_esm2 = 0.00000135936476089485
act_function = 'gelu'
transition_weight = -1.8846152224016033
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), f"{models_output_dir_path}/full_model_{dataset_size}_trained.pth") 
                counter_patience = 0
            else:
                counter_patience += 1
