...
if args.healthtech_cluster:
    input_data_dir_path = "../../../data/processed_data/model_data/shared_crf/model_with_substitution_errors"
    num_workers_cpu = 4
    pin_memory = True
    # Use argparse values
    ...
    os.makedirs(f"/home/projects/DeepCDStmp/data/processed_data/model_data/shared_crf/model_with_substitution_errors/models/", exist_ok=True) #While projects2 fails
    models_output_dir_path = f"/home/projects/DeepCDStmp/data/processed_data/model_data/shared_crf/model_with_substitution_errors/models/"


elif args.scarb_cluster:
    input_data_dir_path = "/tmp/nrt204/FragmentPredictor/data/processed_data/model_data/shared_crf/model_with_substitution_errors" #SCARB cluster
    num_workers_cpu = 4
    pin_memory = True
    # Use argparse values
...
wandb_project_name = "train_esm2_substitution_errors" 
...
dropout_rate_1 = 0.3
dropout_rate_2 = 0.4
lr_scratch = 0.00002138021159489531
lr_esm2 = 0.00000031954521900598
act_function = "relu"
transition_weight = -2.1744764438440565
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), f"{models_output_dir_path}/esm2_8m_{dataset_size}_trained.pth") #modify
                counter_patience = 0
            else:
                counter_patience += 1
