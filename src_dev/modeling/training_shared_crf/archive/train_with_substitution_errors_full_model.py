...
os.makedirs(f"{input_data_dir_path}/data/processed_data/model_data/shared_crf/model_with_substitution_errors/models/", exist_ok=True)

#dir in wandb to place runs
wandb_project_name = "train_full_model_substitution_errors" #MODIFY
dataset_size = "100_genomes" #"200_genomes", "400_genomes", "all_genomes" #MODIFY
...
def load_and_process_data(max_len, dataset_size):
    ...
    val_set = (val_set.groupby("accession_seq_desc_merged", group_keys=False).apply(lambda x: x.sample(frac=0.25, random_state=42))) #0.25
...
dropout_rate_1 = 0.3
dropout_rate_2 = 0.2
lr_scratch = 0.0000329965503225662
lr_esm2 = 0.00000177034941351767
act_function = "relu"
transition_weight = -3.2834275090671325
    ...
    for i, batch in enumerate(train_loader):
        ...
        if step % eval_every_n_steps == 0 and step > 0:
            ...
            if val_avg_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), f"{input_data_dir_path}/models/full_model_{dataset_size}_trained.pth") #modify
                counter_patience = 0
            else:
                counter_patience += 1
