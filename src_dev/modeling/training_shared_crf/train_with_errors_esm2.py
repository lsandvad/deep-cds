...
if args.healthtech_cluster:
    ...
    os.makedirs(f"/home/projects/DeepCDStmp/data/processed_data/model_data/shared_crf/model_with_errors/models/", exist_ok=True) #While projects2 fails
    models_output_dir_path = f"/home/projects/DeepCDStmp/data/processed_data/model_data/shared_crf/model_with_errors/models/"


elif args.scarb_cluster:
    input_data_dir_path = "/tmp/nrt204/FragmentPredictor/data/processed_data/model_data/shared_crf/model_with_errors" #SCARB cluster
    num_workers_cpu = 4
    pin_memory = True
    # Use argparse values
...
wandb.init(project=wandb_project_name, 
           config={
               ...
               name=f"train_{dataset_size}_seed_{args.seed}") #MODIFY
