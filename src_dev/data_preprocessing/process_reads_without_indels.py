...
if __name__ == "__main__":
    ...
    if process_test_reads:
        ...
        # for error_rates in [f"with_errors_1.25e-05i_0.01s_{str(seqs_len)}bp", f"with_errors_3.75e-05i_0.03s_{str(seqs_len)}bp", f"with_errors_5e-06i_0.004s_{str(seqs_len)}bp", f"without_errors_{str(seqs_len)}bp"]:
