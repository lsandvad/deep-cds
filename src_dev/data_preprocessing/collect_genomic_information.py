...
"""
Merge taxonomical information with genomic statistical information for each organism in dataset and remove organisms with no family-level classification
"""

def process_taxonomic_and_genomic_info():
